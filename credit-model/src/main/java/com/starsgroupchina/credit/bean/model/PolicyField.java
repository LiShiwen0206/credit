...
@ApiModel
public class PolicyField extends BaseModel implements Serializable {
    @ApiModelProperty("id")
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        PolicyField other = (PolicyField) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getPolicyId() == null ? other.getPolicyId() == null : this.getPolicyId().equals(other.getPolicyId()))
            && (this.getPolicyGroupId() == null ? other.getPolicyGroupId() == null : this.getPolicyGroupId().equals(other.getPolicyGroupId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPolicyGroupId() == null) ? 0 : getPolicyGroupId().hashCode());
